...
/**
 * Created by Carlos on 13/04/2015.
 * Envía al servidor una petición con una query para ejecutar en el servidor y espera la respuesta.
 */
public class httpHandlerQuery {
    String posturl = "http://vidalbodeloncarlos.xyz/query.php";
